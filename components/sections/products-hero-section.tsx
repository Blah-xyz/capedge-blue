                  ...
                  <div className="bg-gray-900 dark:bg-black rounded-t-3xl p-3 shadow-2xl transform perspective-1000 rotate-x-12">
                    ...
                    <div className="bg-black rounded-t-2xl p-2">
                      ...
                      <div className="bg-white dark:bg-slate-900 rounded-t-xl overflow-hidden relative h-80">
                        ...
                        <div className="absolute top-16 -right-4 bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm rounded-xl px-3 py-2 shadow-lg border border-white/20">
                          <div className="text-sm font-semibold text-blue-600">Analytics</div>
                        </div>
                        <div className="absolute bottom-16 -left-4 bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm rounded-xl px-3 py-2 shadow-lg border border-white/20">
