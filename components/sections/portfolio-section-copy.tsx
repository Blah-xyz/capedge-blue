            ...
            <div className="relative max-w-7xl mx-auto">
              ...
              <AnimatedSection delay={0.2} className="relative mb-12 md:mb-0">
                <div className="md:w-2/3 relative">
                  <div className="bg-blue-800 dark:bg-blue-950 rounded-2xl p-10 border border-blue-700 dark:border-blue-800 shadow-lg hover:shadow-xl transition-all duration-300 min-h-[400px]">
                    {/* Header */}
                    <div className="flex items-start justify-between mb-10">
                      <div>
                        <div className="flex items-center gap-3 mb-6">
                          ...
                          <div className="px-4 py-2 bg-blue-200 dark:bg-blue-900 border border-blue-300 dark:border-blue-700 rounded-full">
                            <span className="text-blue-800 dark:text-blue-300 text-sm font-medium">Active</span>
                          </div>
                        </div>
                        <h3 className="text-4xl font-bold text-blue-100 dark:text-blue-100 mb-3">Enterprise Platform Alpha</h3>
                        <p className="text-lg text-blue-200 dark:text-blue-300">Next-generation enterprise solution</p>
                      </div>
                      <button
                        onClick={() => setIsOpen(true)}
                          className="p-4 bg-blue-700 dark:bg-blue-900 hover:bg-blue-600 dark:hover:bg-blue-800 rounded-xl border border-blue-600 dark:border-blue-700 transition-all duration-300 group/btn"
                      >
                        <ArrowUpRight className="w-6 h-6 text-blue-200 dark:text-blue-400 group-hover/btn:transform group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5 transition-transform duration-300" />
                      </button>
                    </div>
                    ...
                    <div className="space-y-6">
                      <div className="flex items-start gap-4 group/item">
                        <CheckCircle className="w-6 h-6 text-blue-300 dark:text-blue-400 flex-shrink-0 mt-0.5 group-hover/item:scale-110 transition-transform duration-200" />
                        <span className="text-lg text-blue-200 dark:text-blue-200 group-hover/item:text-blue-100 dark:group-hover/item:text-blue-100 transition-colors duration-200">Developed and deployed innovative technology platform</span>
                      </div>
                      <div className="flex items-start gap-4 group/item">
                        <CheckCircle className="w-6 h-6 text-blue-300 dark:text-blue-400 flex-shrink-0 mt-0.5 group-hover/item:scale-110 transition-transform duration-200" />
                        <span className="text-lg text-blue-200 dark:text-blue-200 group-hover/item:text-blue-100 dark:group-hover/item:text-blue-100 transition-colors duration-200">Analytical growth strategies implementation</span>
                      </div>
                      <div className="flex items-start gap-4 group/item">
                        <CheckCircle className="w-6 h-6 text-blue-300 dark:text-blue-400 flex-shrink-0 mt-0.5 group-hover/item:scale-110 transition-transform duration-200" />
                        <span className="text-lg text-blue-200 dark:text-blue-200 group-hover/item:text-blue-100 dark:group-hover/item:text-blue-100 transition-colors duration-200">Active management team empowerment</span>
                      </div>
                      <div className="flex items-start gap-4 group/item">
                        <CheckCircle className="w-6 h-6 text-blue-300 dark:text-blue-400 flex-shrink-0 mt-0.5 group-hover/item:scale-110 transition-transform duration-200" />
                        <span className="text-lg text-blue-200 dark:text-blue-200 group-hover/item:text-blue-100 dark:group-hover/item:text-blue-100 transition-colors duration-200">Comprehensive market analysis and strategic positioning</span>
                      </div>
                    </div>
              ...
              <AnimatedSection delay={0.4} className="md:absolute md:top-24 md:right-0 md:w-2/3">
                <div className="bg-[#002236]  rounded-2xl p-10 border border-blue-700 dark:border-blue-800 shadow-lg hover:shadow-xl transition-all duration-300 min-h-[400px]">
                  {/* Header */}
                  <div className="flex items-start justify-between mb-10">
                    <div>
                      <div className="flex items-center gap-3 mb-6">
                        ...
                        <div className="px-4 py-2 bg-blue-200 dark:bg-blue-900 border border-blue-300 dark:border-blue-700 rounded-full">
                          <span className="text-blue-800 dark:text-blue-300 text-sm font-medium">Thriving</span>
                        </div>
                      </div>
                      <h3 className="text-4xl font-bold text-blue-100 dark:text-blue-100 mb-3">Business Solutions Beta</h3>
                        <p className="text-lg text-blue-200 dark:text-blue-300">Comprehensive business platform</p>
                    </div>
                    <button
                      onClick={() => setIsOpen(true)}
                      className="p-4 bg-blue-700 dark:bg-blue-900 hover:bg-blue-600 dark:hover:bg-blue-800 rounded-xl border border-blue-600 dark:border-blue-700 transition-all duration-300 group/btn"
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-4 group/item">
                        <CheckCircle className="w-6 h-6 text-blue-300 dark:text-blue-400 flex-shrink-0 mt-0.5 group-hover/item:scale-110 transition-transform duration-200" />
                      <span className="text-lg text-blue-200 dark:text-blue-200 group-hover/item:text-blue-100 dark:group-hover/item:text-blue-100 transition-colors duration-200">Successful platform business deployment</span>
                    </div>
                    <div className="flex items-start gap-4 group/item">
                      <CheckCircle className="w-6 h-6 text-blue-300 dark:text-blue-400 flex-shrink-0 mt-0.5 group-hover/item:scale-110 transition-transform duration-200" />
                      <span className="text-lg text-blue-200 dark:text-blue-200 group-hover/item:text-blue-100 dark:group-hover/item:text-blue-100 transition-colors duration-200">Expertise in financial operations and technology</span>
                    </div>
                    <div className="flex items-start gap-4 group/item">
                      <CheckCircle className="w-6 h-6 text-blue-300 dark:text-blue-400 flex-shrink-0 mt-0.5 group-hover/item:scale-110 transition-transform duration-200" />
                      <span className="text-lg text-blue-200  dark:text-blue-200 group-hover/item:text-blue-100 dark:group-hover/item:text-blue-100 transition-colors duration-200">Long-term strategic engagement beyond capital</span>
                    </div>
                    <div className="flex items-start gap-4 group/item">
                      <CheckCircle className="w-6 h-6 text-blue-300 dark:text-blue-400 flex-shrink-0 mt-0.5 group-hover/item:scale-110 transition-transform duration-200" />
                      <span className="text-lg text-blue-200 dark:text-blue-200 group-hover/item:text-blue-100 dark:group-hover/item:text-blue-100 transition-colors duration-200">Advanced analytics and business intelligence</span>
                    </div>
                  </div>
