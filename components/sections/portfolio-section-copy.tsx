      ...
      <div className="container relative max-w-7xl mx-auto px-4">
        ...
        <div className="relative">
          ...
          <div className="relative max-w-7xl mx-auto">
            {/* Enterprise Platform Alpha - Left Side */}
            <AnimatedSection delay={0.2} className="relative mb-12 md:mb-0">
              <div className="md:w-2/3 relative">
                <div className="bg-white dark:bg-slate-900 rounded-2xl p-10 border border-slate-200 dark:border-slate-700 shadow-lg hover:shadow-xl transition-all duration-300 min-h-[400px]">
                  {/* Header */}
                  <div className="flex items-start justify-between mb-10">
                    <div>
                      ...
                      <h3 className="text-4xl font-bold text-slate-900 dark:text-white mb-3">Enterprise Platform Alpha</h3>
                      <p className="text-lg text-slate-600 dark:text-slate-400">Next-generation enterprise solution</p>
                    </div>
                    <button
                      onClick={() => setIsOpen(true)}
                      className="p-4 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 rounded-xl border border-slate-200 dark:border-slate-700 transition-all duration-300 group/btn"
                    >
                      <ArrowUpRight className="w-6 h-6 text-slate-600 dark:text-slate-400 group-hover/btn:transform group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5 transition-transform duration-300" />
                    </button>
                  </div>
            ...
            {/* Business Solutions Beta - Right Side */}
            <AnimatedSection delay={0.4} className="md:absolute md:top-24 md:right-0 md:w-2/3">
              <div className="bg-slate-900 dark:bg-white rounded-2xl p-10 border border-slate-700 dark:border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300 min-h-[400px]">
                {/* Header */}
                <div className="flex items-start justify-between mb-10">
                  <div>
                    <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-4xl font-bold text-white dark:text-slate-900 mb-3">Business Solutions Beta</h3>
                    <p className="text-lg text-slate-300 dark:text-slate-600">Comprehensive business platform</p>
                  </div>
                  <button
                    onClick={() => setIsOpen(true)}
                    className="p-4 bg-slate-800 dark:bg-slate-100 hover:bg-slate-700 dark:hover:bg-slate-200 rounded-xl border border-slate-700 dark:border-slate-200 transition-all duration-300 group/btn"
                  >
                    <ArrowUpRight className="w-6 h-6 text-slate-300 dark:text-slate-600 group-hover/btn:transform group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5 transition-transform duration-300" />
                  </button>
                </div>
