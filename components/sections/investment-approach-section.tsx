...
import { Search, Brain, Target, TrendingUp, Lightbulb, Zap, Sparkles, CheckCircle } from "lucide-react";
	...
	return (
		<section id="investment-approach" className="relative overflow-hidden">
			...
			<div className="relative bg-gradient-to-br from-slate-50 via-slate-100 to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 py-20">
				...
				<div className="absolute bottom-10 right-10 w-40 h-40 bg-red-400/5 rounded-full blur-3xl"></div>

				<div className="container relative max-w-7xl mx-auto px-4">
					<div className="text-center max-w-4xl mx-auto">
						<AnimatedSection>
							<div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-50/80 dark:bg-red-950/30 text-red-600 dark:text-red-400 text-sm font-medium mb-6 backdrop-blur-sm border border-red-200/30 dark:border-red-800/30">
								<Sparkles className="w-4 h-4" />
								Investment Philosophy
							</div>

							<h2 className="text-4xl lg:text-6xl font-bold mb-6 leading-tight">
								<span className="bg-gradient-to-r from-slate-900 via-red-600 to-slate-800 dark:from-white dark:via-red-400 dark:to-slate-200 bg-clip-text text-transparent">
			...
			{/* DEEPEN Section - Light background with crimson accents */}
			<div className="relative bg-gradient-to-br from-white via-slate-50 to-slate-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 py-24 overflow-hidden">
				...
				<div className="absolute -top-20 -right-20 w-40 h-40 bg-red-600/10 rotate-45 rounded-2xl"></div>
				<div className="absolute top-40 right-20 w-20 h-20 bg-red-500/10 rotate-12 rounded-xl"></div>
					...
					<div className="grid lg:grid-cols-2 gap-16 items-center">
						...
						<AnimatedSection className="text-left">
							<div className="flex items-center gap-4 mb-8">
								<div className="w-16 h-16 bg-red-600 rounded-2xl flex items-center justify-center shadow-lg shadow-red-600/25">
									<Search className="w-8 h-8 text-white" />
								</div>
								<div>
									<h3 className="text-4xl font-bold text-slate-900 dark:text-white mb-2">DEEPEN</h3>
									<p className="text-red-600 dark:text-red-400 text-lg font-medium">Knowledge & Understanding</p>
								</div>
							</div>
						...
						{/* <AnimatedSection delay={0.2} direction="right">
							<div className="relative">
								<div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-3xl p-8 border border-slate-200/50 dark:border-slate-700/50 shadow-xl shadow-red-600/5">
			...
			{/* UNDERSTAND Section - Slate background with crimson accents */}
			<div className="relative bg-gradient-to-l from-slate-100 via-slate-200 to-slate-100 dark:from-slate-800 dark:via-slate-900 dark:to-slate-800 py-24 overflow-hidden">
				...
				<div className="absolute bottom-0 left-0 w-full  opacity-5">
					<svg className="w-full h-full" viewBox="0 0 1200 400" fill="none">
						<path d="M0,100 Q300,50 600,100 T1200,100 L1200,400 L0,400 Z" fill="currentColor" className="text-red-600"/>
						<path d="M0,150 Q300,100 600,150 T1200,150 L1200,400 L0,400 Z" fill="currentColor" className="text-red-500"/>
					</svg>
				</div>
					...
					<div className="grid lg:grid-cols-2 gap-16 items-center">
						...
						{/* <AnimatedSection delay={0.1} direction="left">
							<div className="relative lg:order-1">
								<div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm rounded-3xl p-8 border border-slate-200/50 dark:border-slate-700/50 shadow-xl shadow-red-600/5">
									<div className="space-y-6">
										...
										<div className="grid grid-cols-2 gap-4">
											{[
												...
												<div key={index} className="text-center p-4 bg-slate-50 dark:bg-slate-700/50 rounded-xl border border-slate-200/50 dark:border-slate-600/50">
													<div className="text-2xl font-bold text-red-600 dark:text-red-400 mb-1">{metric.value}</div>
						...
						<AnimatedSection className="text-left lg:order-2">
							<div className="flex items-center gap-4 mb-8">
								...
								<div>
									...
									<p className="text-red-600 dark:text-red-400 text-lg font-medium">Operational Challenges</p>
								</div>
							</div>
			...
			{/* INVEST Section - White background with crimson accents */}
			<div className="relative bg-gradient-to-br from-white via-slate-50 to-white dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 py-24 overflow-hidden">
				{/* Subtle Floating Background Elements */}
				<div className="absolute top-20 left-1/4 w-32 h-32 bg-red-500/5 rounded-2xl rotate-12 blur-sm"></div>
				<div className="absolute bottom-20 right-1/4 w-24 h-24 bg-red-600/10 rounded-xl rotate-45"></div>
				<div className="absolute top-1/2 left-10 w-16 h-16 bg-red-500/5 rounded-full"></div>
				<div className="absolute top-1/3 right-10 w-20 h-20 bg-red-600/5 rounded-2xl rotate-45"></div>
					...
					<div className="text-center max-w-4xl mx-auto">
						...
						<AnimatedSection>
							<div className="flex items-center justify-center gap-4 mb-8">
								<div className="w-20 h-20 bg-red-600 rounded-3xl flex items-center justify-center shadow-xl shadow-red-600/25">
									<Target className="w-10 h-10 text-white" />
								</div>
								<div className="text-left">
									<h3 className="text-5xl font-bold text-slate-900 dark:text-white mb-2">INVEST</h3>
									<p className="text-red-600 dark:text-red-400 text-xl font-medium">Promising Solutions</p>
								</div>
							</div>
